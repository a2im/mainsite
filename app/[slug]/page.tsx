...
const posts: PostRelationResponseCollection = await res.json()
  ...
  return <div className=" bg-neutral-50 dark:bg-neutral-600 pb-20">
...
<Link href={"/news"}>
  ...
  {posts?.data.map(posts => (
            <div key={posts.id} className="mx-auto bg-white text-black dark:bg-neutral-800 dark:text-white">
