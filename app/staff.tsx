...
export function MainBoard() {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row mx-auto px-5 pt-10 max-w-6xl gap-4">
            <div className="w-[180px]">
            <h2 className="text-2xl 1/6">Board of Directors</h2>
            <hr className="a2im-border-wrap1 border-transparent mr-0"></hr>
            </div>
        <div className='mt-2 grid grid-cols-0 md:grid-cols-4 gap-5  mb-20'>
...
export function Staff() {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row mx-auto px-5 pt-10 max-w-6xl gap-4">
            <div className="w-[180px]">
            <h2 className="text-2xl 1/6">A2IM Staff</h2>
            <hr className="a2im-border-wrap1 border-transparent mr-0"></hr>
            </div>
        <div className='mt-2 grid grid-cols-0 md:grid-cols-4 gap-5 mb-20'>
        {data?.staffs.data.map(staffs => (
...
export default function A2IMStaff(){
    return (
